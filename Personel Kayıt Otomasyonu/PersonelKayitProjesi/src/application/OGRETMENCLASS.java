...
public class OGRETMENCLASS {
    ...
    //ogretmen
    OGRETMENCLASS(  Integer ID, String adi, String Soyadi,String D_Tarihi,String Tc_Kimlik,String Telefon_No,
			String Medeni_Hal, Double Maas,String Adres, String Egitim,Double ORTALAMA,String Hangikesim,String Brans,String mail){
  	  super(); 
	...
	public String getHangikesim() {
		return Hangikesim;
	}
	public void setHangikesim(String hangikesim) {
		Hangikesim = hangikesim;
	}
