...
public class MimarlikController {
	   Connection baglanti=null;
	    PreparedStatement sorguifadesi=null;
	    ResultSet getirilen=null;
	    String sql,sql1;
	   
		public MimarlikController() {
    ...
    void Btn_Guncelle_Click(ActionEvent event) {
     {
    	 ...
    	 sql="update mimarlik set madi=?,msoyadi=?,msorgu=?,yalan=? where ykimlik=?";
    	try {
    		if(txt_Adi.getText()!="") {
    ...
    void Btn_Kaydet_Click(ActionEvent event) {
		...
		sql="insert into  mimarlik(Fakulte,madi,msoyadi,ydogumtarihi,ykimlik,ytelefon,ymedenihal,ymaas,yadres,mLisans,mOrtalama,mtecrube,yalan,msorgu,brans,email)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    	try {
			
    		sorguifadesi=baglanti.prepareStatement(sql);
    		sorguifadesi.setString(1, "Mimarlýk");
    		...
    		if(radio_evli.isSelected()) {
    			...
    			System.out.println("muz ekle");
    		}
    		sorguifadesi.setInt(8, Integer.parseInt( txt_Maas.getText().trim()));
    		sorguifadesi.setString(9, txt_Area_Adres.getText().trim());
    		sorguifadesi.setString(10, Lisans.getText().trim());
    		...
    		sorguifadesi.setString(12, Text_Area_Tecrube.getText().trim());
     		...
     		if(Check1.isSelected()) {
    			sorguifadesi.setString(15, "MIMAR" );
    			
    		}else if(check2.isSelected()) {
    			sorguifadesi.setString(15, "IC MIMAR" );
    		}else {
    			System.out.println("elma ekle");
    		}
     		sorguifadesi.setString(16, txtmail.getText().trim());
