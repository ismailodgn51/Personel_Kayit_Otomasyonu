...
public class fMIMARCLASS {
	    ...
	    fMIMARCLASS() {
	     ...
	     //mimariçin
	    fMIMARCLASS(Integer ID,String fakulte, String adi, String Soyadi,String D_Tarihi,String Tc_Kimlik,String Telefon_No,
	    	  			String Medeni_Hal, Double Maas,String Adres, String Egitim,String Tecrube,  String Alan ,String Brans,Double ORTALAMA, String sorgu,String mail){
	    	    	  super(); 
